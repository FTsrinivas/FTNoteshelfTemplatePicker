...
public class FTPopupView {
    ...
    public FTPopupView(Context context) {
        this.mContext = context;
        this.mNormalTextColor = DEFAULT_NORMAL_TEXT_COLOR;
        this.mPressedTextColor = DEFAULT_PRESSED_TEXT_COLOR;
        this.mTextSize = ScreenUtil.convertDpToPx(context, context.getResources().getInteger(R.integer.fourteen));
        this.mTextPaddingLeft = ScreenUtil.convertDpToPx(context, context.getResources().getInteger(R.integer.ten));
        this.mTextPaddingTop = ScreenUtil.convertDpToPx(context, context.getResources().getInteger(R.integer.five));
        this.mTextPaddingRight = ScreenUtil.convertDpToPx(context, context.getResources().getInteger(R.integer.ten));
        this.mTextPaddingBottom = ScreenUtil.convertDpToPx(context, context.getResources().getInteger(R.integer.five));
        this.mNormalBackgroundColor = DEFAULT_NORMAL_BACKGROUND_COLOR;
        this.mPressedBackgroundColor = DEFAULT_PRESSED_BACKGROUND_COLOR;
        this.mBackgroundCornerRadius = ScreenUtil.convertDpToPx(context, context.getResources().getInteger(R.integer.eight));
        this.mDividerColor = DEFAULT_DIVIDER_COLOR;
        this.mDividerWidth = ScreenUtil.convertDpToPx(context, context.getResources().getInteger(R.integer.two));
        this.mDividerHeight = ScreenUtil.convertDpToPx(context, context.getResources().getInteger(R.integer.sixteen));
    ...
    public View getDefaultIndicatorView(Context context) {
        return getTriangleIndicatorView(context, ScreenUtil.convertDpToPx(context, context.getResources().getInteger(R.integer.sixteen)), ScreenUtil.convertDpToPx(context, context.getResources().getInteger(R.integer.eight)), DEFAULT_NORMAL_BACKGROUND_COLOR);
    }
    ...
    public interface PopupListListener {
        ...
        /**
         * Whether the FTPopupView should be bound to the special view
         *
         ...
         * @return true if the view should bind the FTPopupView, false otherwise
         */
        boolean showPopupList(View adapterView, View contextView, int contextPosition);

        /**
         * The callback to be invoked with an item in this FTPopupView has
         * been clicked
         *
         * @param contextView     The context view(The AbsListView where the click happened or normal view).
         * @param contextPosition The position of the view in the list
         * @param position        The position of the view in the FTPopupView
         */
