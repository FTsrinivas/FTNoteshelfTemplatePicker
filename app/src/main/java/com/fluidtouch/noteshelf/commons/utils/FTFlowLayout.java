...
public class FTFlowLayout extends ViewGroup {
    ...
    public FTFlowLayout(Context context) {
        this(context, null);
    }

    public FTFlowLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FTFlowLayout(Context context, AttributeSet attrs, int defStyle) {
