...
public class CompatibilityHelper {
    ...
    public static PDAnnotationLink createLink(PDPage page, PDRectangle rect, AWTColor color,
    ...
    private static PDAnnotationLink createLink(PDPage page, PDRectangle rect, AWTColor color,
