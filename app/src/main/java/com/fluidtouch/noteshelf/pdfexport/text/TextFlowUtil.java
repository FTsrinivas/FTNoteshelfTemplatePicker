...
import com.fluidtouch.noteshelf.pdfexport.text.ControlCharacters.BoldControlCharacter;
import com.fluidtouch.noteshelf.pdfexport.text.ControlCharacters.ColorControlCharacter;
import com.fluidtouch.noteshelf.pdfexport.text.ControlCharacters.ControlCharacterFactory;
import com.fluidtouch.noteshelf.pdfexport.text.ControlCharacters.ItalicControlCharacter;
import com.fluidtouch.noteshelf.pdfexport.text.ControlCharacters.MetricsControlCharacter;
import com.fluidtouch.noteshelf.pdfexport.text.ControlCharacters.NewLineControlCharacter;
import com.fluidtouch.noteshelf.pdfexport.text.IndentCharacters.IndentCharacter;
import com.fluidtouch.noteshelf.pdfexport.text.annotations.AnnotatedStyledText;
import com.fluidtouch.noteshelf.pdfexport.text.annotations.Annotation;
import com.fluidtouch.noteshelf.pdfexport.text.annotations.AnnotationCharacters;
...
public class TextFlowUtil {
    ...
    public static TextFlow createTextFlow(final String text,
                                          final float fontSize, final PDFont font, AWTColor color) throws IOException {
        final Iterable<CharSequence> parts = fromPlainText(text);
    ...
    protected static TextFlow createTextFlow(
        ...
        return createTextFlow(parts, fontSize, plainFont, boldFont,
                italicFont, boldItalicFont, new AWTColor((Color.BLACK)));
    }

    protected static TextFlow createTextFlow(
            final Iterable<CharSequence> parts, final float fontSize,
            final PDFont plainFont, final PDFont boldFont,
            final PDFont italicFont, final PDFont boldItalicFont, AWTColor color)
            throws IOException {
