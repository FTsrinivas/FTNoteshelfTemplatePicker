...
import com.fluidtouch.noteshelf.pdfexport.util.Enumerator;
import com.fluidtouch.noteshelf.pdfexport.util.EnumeratorFactory;
...
public class IndentCharacters {
    ...
    public static class IndentCharacter extends ControlCharacter {
        ...
        public Indent createNewIndent(final float fontSize, final PDFont font,
                                      final AWTColor color) throws IOException {
