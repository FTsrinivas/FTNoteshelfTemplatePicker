...
import com.fluidtouch.noteshelf.pdfexport.text.ControlCharacter;
...
public class AnnotationCharacters {
    ...
    public static class HyperlinkControlCharacter extends
            AnnotationControlCharacter<Annotations.HyperlinkAnnotation> {
    ...
    public static class AnchorControlCharacter extends
            AnnotationControlCharacter<Annotations.AnchorAnnotation> {
    ...
    public static class UnderlineControlCharacter extends
            AnnotationControlCharacter<Annotations.UnderlineAnnotation> {
        ...
        protected UnderlineControlCharacter(String baselineOffsetScaleValue,
            ...
            line = new Annotations.UnderlineAnnotation(baselineOffsetScale, lineWeight);
        }
