...
// Custom API
//////////////////////////////////////////
JNI_FUNC(jobject, PdfiumSDK, nativeGetPageBoundingBox)(JNI_ARGS, jlong pagePtr) {
    FPDF_PAGE page = reinterpret_cast<FPDF_PAGE>(pagePtr);
    FS_RECTF fsRectF;
    FPDF_BOOL result = FPDF_GetPageBoundingBox(page, &fsRectF);
...
JNI_FUNC(jobject, PdfiumSDK, nativeGetCropBox)(JNI_ARGS, jlong pagePtr) {
    FPDF_PAGE page = reinterpret_cast<FPDF_PAGE>(pagePtr);
    FS_RECTF fsRectF;
    FPDF_BOOL result = FPDFPage_GetCropBox(page, &fsRectF.left, &fsRectF.bottom, &fsRectF.right,
                                           &fsRectF.top);
...
JNI_FUNC(jobject, PdfiumSDK, nativeGetMediaBox)(JNI_ARGS, jlong pagePtr) {
    FPDF_PAGE page = reinterpret_cast<FPDF_PAGE>(pagePtr);
    FS_RECTF fsRectF;
    FPDF_BOOL result = FPDFPage_GetMediaBox(page, &fsRectF.left, &fsRectF.bottom, &fsRectF.right,
                                            &fsRectF.top);
...
/*JNI_FUNC(jobject, PdfiumSDK, nativeGetBleedBox)(JNI_ARGS, jlong pagePtr) {
    FPDF_PAGE page = reinterpret_cast<FPDF_PAGE>(pagePtr);
    FS_RECTF fsRectF;
    FPDF_BOOL result = FPDFPage_GetBleedBox(page, &fsRectF.left, &fsRectF.bottom, &fsRectF.right,
                                            &fsRectF.top);
...
JNI_FUNC(jobject, PdfiumSDK, nativeGetTrimBox)(JNI_ARGS, jlong pagePtr) {
    FPDF_PAGE page = reinterpret_cast<FPDF_PAGE>(pagePtr);
    FS_RECTF fsRectF;
    FPDF_BOOL result = FPDFPage_GetTrimBox(page, &fsRectF.left, &fsRectF.bottom, &fsRectF.right,
                                           &fsRectF.top);
...
JNI_FUNC(jobject, PdfiumSDK, nativeGetArtBox)(JNI_ARGS, jlong pagePtr) {
    FPDF_PAGE page = reinterpret_cast<FPDF_PAGE>(pagePtr);
    FS_RECTF fsRectF;
    FPDF_BOOL result = FPDFPage_GetArtBox(page, &fsRectF.left, &fsRectF.bottom, &fsRectF.right,
                                          &fsRectF.top);
