...
public enum Edge implements Serializable {
    ...
    public void adjustCoordinate(float aspectRatio) {
        ...
        switch (this) {
            case LEFT:
                mCoordinate = AspectRatio.calculateLeft(top, right, bottom, aspectRatio);
                break;
            case TOP:
                mCoordinate = AspectRatio.calculateTop(left, right, bottom, aspectRatio);
                break;
            case RIGHT:
                mCoordinate = AspectRatio.calculateRight(left, top, bottom, aspectRatio);
                break;
            case BOTTOM:
                mCoordinate = AspectRatio.calculateBottom(left, top, right, aspectRatio);
                break;
        }
    }
        ...
        switch (this) {
            ...
            case LEFT:
                ...
                if (edge.equals(Edge.TOP)) {
                    ...
                    final float right = Edge.RIGHT.getCoordinate();
                    final float left = AspectRatio.calculateLeft(top, right, bottom, aspectRatio);
            ...
            case TOP:
                ...
                if (edge.equals(Edge.LEFT)) {
                    ...
                    final float bottom = Edge.BOTTOM.getCoordinate();
                    final float top = AspectRatio.calculateTop(left, right, bottom, aspectRatio);
            ...
            case RIGHT:
                ...
                if (edge.equals(Edge.TOP)) {
                    ...
                    final float bottom = Edge.BOTTOM.getCoordinate() - offset;
                    final float left = Edge.LEFT.getCoordinate();
                    final float right = AspectRatio.calculateRight(left, top, bottom, aspectRatio);
            ...
            case BOTTOM:
                ...
                if (edge.equals(Edge.LEFT)) {
                    ...
                    final float right = Edge.RIGHT.getCoordinate() - offset;
                    final float top = Edge.TOP.getCoordinate();
                    final float bottom = AspectRatio.calculateBottom(left, top, right, aspectRatio);
