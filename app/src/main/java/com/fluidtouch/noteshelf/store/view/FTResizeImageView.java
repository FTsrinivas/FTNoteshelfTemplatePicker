 ...
 */
public class FTResizeImageView extends AppCompatImageView {

    private TouchManager touchManager;
    private FTResizeViewConfig config;
    ...
    public FTResizeImageView(Context context) {
        super(context);
        initCropView(context, null);
    }

    public FTResizeImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    void initCropView(Context context, AttributeSet attrs) {
        config = FTResizeViewConfig.from(context, attrs);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        drawBitmap(canvas);
        //no need to draw overlay on image
