...
public class ColorPickerView extends View {
    ...
    private int HUE_PANEL_WDITH_DP = 78;
    private int ALPHA_PANEL_HEIGH_DP = 20;
    private int PANEL_SPACING_DP = 24;
    private int CIRCLE_TRACKER_RADIUS_DP = 12;
    private int SLIDER_TRACKER_SIZE_DP = 4;
    private int SLIDER_TRACKER_OFFSET_DP = 2;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        HUE_PANEL_WDITH_DP = getResources().getInteger(R.integer.cpv_integer_78);
        ALPHA_PANEL_HEIGH_DP = getResources().getInteger(R.integer.cpv_integer_20);
        PANEL_SPACING_DP = getResources().getInteger(R.integer.cpv_integer_24);
        CIRCLE_TRACKER_RADIUS_DP = getResources().getInteger(R.integer.cpv_integer_12);
        SLIDER_TRACKER_SIZE_DP = getResources().getInteger(R.integer.cpv_integer_4);
        SLIDER_TRACKER_OFFSET_DP = getResources().getInteger(R.integer.cpv_integer_2);
    ...
    private void initPaintTools() {
        ...
        satValTrackerPaint.setStrokeWidth(DrawingUtils.dpToPx(getContext(), getResources().getInteger(R.integer.cpv_integer_2)));
        ...
        hueAlphaTrackerPaint.setStrokeWidth(DrawingUtils.dpToPx(getContext(), getResources().getInteger(R.integer.cpv_integer_2)));
        hueAlphaTrackerPaint.setAntiAlias(true);

        alphaTextPaint.setColor(0xff1c1c1c);
        alphaTextPaint.setTextSize(DrawingUtils.dpToPx(getContext(), getResources().getInteger(R.integer.cpv_integer_12)));
    ...
    private void drawSatValPanel(Canvas canvas) {
        ...
        if (BORDER_WIDTH_PX > 0) {
            ...
            canvas.drawRoundRect(new RectF(drawingRect.left, drawingRect.top, rect.right + BORDER_WIDTH_PX, rect.bottom + BORDER_WIDTH_PX),
                    DrawingUtils.dpToPx(getContext(), 4), DrawingUtils.dpToPx(getContext(), 4), borderPaint);
        }
...
//                satValBackgroundCache.bitmap = getRoundedCornerBitmap(getContext(), satValBackgroundCache.bitmap, DrawingUtils.dpToPx(getContext(), 4));
            }
            ...
            satValBackgroundCache.canvas.drawRoundRect(new RectF(0, 0, satValBackgroundCache.bitmap.getWidth(),
                    satValBackgroundCache.bitmap.getHeight()), DrawingUtils.dpToPx(getContext(), getResources().getInteger(R.integer.cpv_integer_4)), DrawingUtils.dpToPx(getContext(), getResources().getInteger(R.integer.cpv_integer_4)), satValPaint);
        ...
        if (selectedColor == Color.BLACK) {
            p = new Point(Math.min(lastTouchPoint.x, satValRect.width() + satValRect.left), Math.min(lastTouchPoint.y, satValRect.height() + satValRect.top));
        }

        satValTrackerPaint.setShadowLayer(12, 0, 0, Color.parseColor("#383838"));

//        satValTrackerPaint.setColor(0x00000019);
//        canvas.drawCircle(p.x, p.y, circleTrackerRadiusPx + DrawingUtils.dpToPx(getContext(), 1), satValTrackerPaint);

        satValTrackerPaint.setColor(0xffffffe6);
        ...
        canvas.drawCircle(p.x, p.y, circleTrackerRadiusPx - DrawingUtils.dpToPx(getContext(), 1), paint);
    }
    ...
    private void drawHuePanel(Canvas canvas) {
        ...
        if (BORDER_WIDTH_PX > 0) {
            ...
            canvas.drawRoundRect(new RectF(rect.left - BORDER_WIDTH_PX, rect.top - BORDER_WIDTH_PX, rect.right + BORDER_WIDTH_PX, rect.bottom + BORDER_WIDTH_PX),
                    DrawingUtils.dpToPx(getContext(), 4), DrawingUtils.dpToPx(getContext(), 4), borderPaint);
        }
...
//        hueBackgroundCache.canvas.drawRoundRect(new RectF(rect), DrawingUtils.dpToPx(getContext(),4), DrawingUtils.dpToPx(getContext(),4), borderPaint);
        ...
        hueAlphaTrackerPaint.setShadowLayer(12, 0, 0, Color.parseColor("#383838"));

//        hueAlphaTrackerPaint.setColor(0x00000019);
//        canvas.drawCircle(r.centerX(), r.centerY(), circleTrackerRadiusPx - DrawingUtils.dpToPx(getContext(), 1), hueAlphaTrackerPaint);

        hueAlphaTrackerPaint.setColor(0xffffffe6);
        canvas.drawCircle(r.centerX(), r.centerY(), circleTrackerRadiusPx, hueAlphaTrackerPaint);

        Paint paint = new Paint();
        paint.setStyle(Style.FILL);
        paint.setAntiAlias(true);
        paint.setColor(Color.HSVToColor(new float[]{hue, 1f, 1f}));
        canvas.drawCircle(r.centerX(), r.centerY(), circleTrackerRadiusPx - DrawingUtils.dpToPx(getContext(), 1), paint);
...
//        canvas.drawRoundRect(r, 2, 2, hueAlphaTrackerPaint);
    ...
    private void drawAlphaPanel(Canvas canvas) {
        ...
        if (alphaSliderText != null && !alphaSliderText.equals("")) {
            canvas.drawText(alphaSliderText, rect.centerX(), rect.centerY() + DrawingUtils.dpToPx(getContext(), getResources().getInteger(R.integer.cpv_integer_4)),
                    alphaTextPaint);
        }
